...
var simple = simpleContract.new(42, {from:web3.eth.accounts[0], data: simpleCompiled[simpleRoot].code, gas: 300000, privateFor: ["RykjfPXBraALtbbXnQgywEg+5kghxIYWSHe1xEMPi2g="]}, function(e, contract) {
  if (e) {
...
var simple1 = simpleContract.new(23, {from:web3.eth.accounts[0], data: simpleCompiled[simpleRoot].code, gas: 300000, privateFor: ["RykjfPXBraALtbbXnQgywEg+5kghxIYWSHe1xEMPi2g="]}, function(e, contract) {
  if (e) {
    console.log("err creating contract", e);
  } else {
    if (!contract.address) {
